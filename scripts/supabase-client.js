...
// Acessa o objeto 'supabase' global (do CDN) para chamar a função createClient.
// O resultado é armazenado em uma nova constante, que estamos chamando de 'supabaseClient' para evitar confusão.
const supabaseClient = supabase.createClient(SUPABASE_URL, SUPABASE_ANON_KEY);

// Exporta o cliente inicializado para ser usado em outros lugares
